...
export const SavedRollItem = ({ roll, onRoll, onUpdate, onDelete, attributes, listeners, setNodeRef }) => {
  ...
  return (
    <div ref={setNodeRef} tabIndex={0} className="bg-[#0a0a0a] border border-[#cd7f32] border-opacity-50 rounded-lg p-1.5 sm:p-2 transition-all duration-200 hover:bg-[#1a1a1a] origin-center">
